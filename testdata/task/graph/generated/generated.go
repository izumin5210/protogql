...
type DirectiveRoot struct {
	...
	Protobuf func(ctx context.Context, obj interface{}, next graphql.Resolver, typeArg string) (res interface{}, err error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Task.assigneeIds":
		if e.complexity.Task.AssigneeIds == nil {
			break
		}

		return e.complexity.Task.AssigneeIds(childComplexity), true
...
# from https://gqlgen.com/config/#inline-config-with-directives
directive @goField(forceResolver: Boolean = false, name: String) on INPUT_FIELD_DEFINITION
    | FIELD_DEFINITION
...
`, BuiltIn: false},
	{Name: "graph/task.pb.graphqls", Input: `type Task @protobuf(type: "testdata.task.Task") @goModel(model: "testdata/task/graph/model.Task") {
	id: Int! @goField(name: "Id", forceResolver: false)
	title: String! @goField(name: "Title", forceResolver: false)
	status: TaskStatus! @goField(name: "Status", forceResolver: false)
	assigneeIds: [Int!]! @goField(name: "AssigneeIds", forceResolver: false)
}
input TaskInput @protobuf(type: "testdata.task.Task") @goModel(model: "testdata/task/graph/model.Task") {
	id: Int! @goField(name: "Id")
	title: String! @goField(name: "Title")
	status: TaskStatus! @goField(name: "Status")
	assigneeIds: [Int!]! @goField(name: "AssigneeIds")
}
enum TaskStatus @protobuf(type: "testdata.task.Task.Status") @goModel(model: "testdata/task/graph/model.TaskStatus") {
	STATUS_UNSPECIFIED
	TODO
	IN_PROGRESS
	DONE
...
`, BuiltIn: false},
	{Name: "graph/user.pb.graphqls", Input: `type User @protobuf(type: "testdata.tasks.User") @goModel(model: "testdata/task/graph/model.User") {
	id: Int! @goField(name: "Id", forceResolver: false)
	fullName: String! @goField(name: "FullName", forceResolver: false)
	role: UserRole! @goField(name: "Role", forceResolver: false)
}
input UserInput @protobuf(type: "testdata.tasks.User") @goModel(model: "testdata/task/graph/model.User") {
	id: Int! @goField(name: "Id")
	fullName: String! @goField(name: "FullName")
	role: UserRole! @goField(name: "Role")
}
enum UserRole @protobuf(type: "testdata.tasks.User.Role") @goModel(model: "testdata/task/graph/model.UserRole") {
	ROLE_UNSPECIFIED
	ADMIN
}
`, BuiltIn: false},
...
func (ec *executionContext) _Query_tasks(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive1 := func(ctx context.Context) (interface{}, error) {
			typeArg, err := ec.unmarshalNString2string(ctx, "testdata.task.Task")
			if err != nil {
				return nil, err
			}
			if ec.directives.Protobuf == nil {
				return nil, errors.New("directive protobuf is not implemented")
			}
			return ec.directives.Protobuf(ctx, nil, directive0, typeArg)
		}
...
func (ec *executionContext) _Task_status(ctx context.Context, field graphql.CollectedField, obj *model.Task) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive1 := func(ctx context.Context) (interface{}, error) {
			...
			return ec.directives.Protobuf(ctx, obj, directive0, typeArg)
		}
...
func (ec *executionContext) _Task_assignees(ctx context.Context, field graphql.CollectedField, obj *model.Task) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive1 := func(ctx context.Context) (interface{}, error) {
			typeArg, err := ec.unmarshalNString2string(ctx, "testdata.tasks.User")
			if err != nil {
				return nil, err
			}
			if ec.directives.Protobuf == nil {
...
func (ec *executionContext) unmarshalInputTaskInput(ctx context.Context, obj interface{}) (model.Task, error) {
	var it model.Task
...
func (ec *executionContext) _Task(ctx context.Context, sel ast.SelectionSet, obj *model.Task) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "assigneeIds":
			out.Values[i] = ec._Task_assigneeIds(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&invalids, 1)
			}
		case "assignees":
...
func (ec *executionContext) unmarshalNInt2ᚕuint64ᚄ(ctx context.Context, v interface{}) ([]uint64, error) {
...
func (ec *executionContext) marshalNInt2ᚕuint64ᚄ(ctx context.Context, sel ast.SelectionSet, v []uint64) graphql.Marshaler {
