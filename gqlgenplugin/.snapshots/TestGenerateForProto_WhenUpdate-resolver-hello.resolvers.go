...
func (r *helloResolver) User(ctx context.Context, obj *model.Hello) (*model.User, error) {
	...
	resp, err := (&helloProtoResolver{Resolver: r.Resolver}).User(ctx, model.HelloToProto(obj))
	if err != nil {
		return nil, err
	}
...
func (r *queryResolver) Hellos(ctx context.Context) ([]*model.Hello, error) {
	// This function body is generated by github.com/izumin5210/protogql. DO NOT EDIT.

	resp, err := (&queryProtoResolver{Resolver: r.Resolver}).Hellos(ctx)
	if err != nil {
		return nil, err
	}
